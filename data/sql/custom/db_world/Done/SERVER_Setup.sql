...
-- Make Scarlet Monestary a sanctuary and Azshara Crater Free-for-all
...
-- Make Scarlet Monestary an open-world map
...
-- All stable slots free
REPLACE INTO `stableslotprices_dbc` (`ID`, `Cost`) VALUES 
(1, 0),
(2, 0),
(3, 0),
(4, 0);
...
-- Allow players to use account and character customization commands
