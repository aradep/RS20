...
-- Re-enable Argent Tournament Grounds
...
-- Re-disable unwanted NPCs in Argent Tournament Grounds
UPDATE `creature`   SET `spawnMask` = '0' WHERE `id1` NOT IN (17213, 36069, 33543, 33643, 28756, 20735, 32287, 30115);
