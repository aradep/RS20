...
-- PvE mounts
(@Entry,      2,      @EmblemofValor_x15,   /*Stormwind Steed*/45125),
(@Entry,      2,      @EmblemofValor_x15,   /*Ironforge Ram*/45586),
(@Entry,      2,      @EmblemofValor_x15,   /*Gnomeregan Mechanostrider*/45589),
(@Entry,      2,      @EmblemofValor_x15,   /*Exodar Elekk*/45590),
(@Entry,      2,      @EmblemofValor_x15,   /*Darnassian Nightsaber*/45591),
(@Entry,      2,      @EmblemofValor_x15,   /*Thunder Bluff Kodo*/45592),
(@Entry,      2,      @EmblemofValor_x15,   /*Darkspear Raptor*/45593),
(@Entry,      2,      @EmblemofValor_x15,   /*Orgrimmar Wolf*/45595),
(@Entry,      2,      @EmblemofValor_x15,   /*Silvermoon Hawkstrider*/45596),
(@Entry,      2,      @EmblemofValor_x15,   /*Forsaken Warhorse*/45597),
...
-- PvP mounts
(@Entry,      7,      @40000_Honor,     /*Black War Kodo,*/29466),
(@Entry,      7,      @40000_Honor,     /*Black War Ram,*/29467),
(@Entry,      7,      @40000_Honor,     /*Black War Steed Bridle,*/29468),
(@Entry,      7,      @40000_Honor,     /*Horn of the Black War Wolf,*/29469),
(@Entry,      7,      @40000_Honor,     /*Reins of the Black War Tiger,*/29471),
(@Entry,      7,      @40000_Honor,     /*Whistle of the Black War Raptor,*/29472),
(@Entry,      7,      @40000_Honor,     /*Reins of the Black War Elekk,*/35906),
(@Entry,      7,      @40000_Honor,     /*Reins of the Black War Bear,*/44223),
(@Entry,      7,      @40000_Honor,     /*Reins of the Black War Bear,*/44224),
(@Entry,      7,      @40000_Honor,     /*Swift Warstrider*/34129),
(@Entry,      7,      @40000_Honor,     /*Reins of the Black War Mammoth,*/44077),
(@Entry,      7,      @40000_Honor,     /*Reins of the Black War Mammoth,*/43956),
(@Entry,      7,      @40000_Honor,     /*Black Battlestrider*/29465),
