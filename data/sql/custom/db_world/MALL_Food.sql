...
-- Fruit Vendor
DELETE FROM npc_vendor WHERE Entry=@Applebough; INSERT INTO npc_vendor 
-- ----------------------------------------------------------------------
(Entry,         Slot,       Item) VALUES
-- ----------------------------------------------------------------------
(@Applebough,   1,          43087), -- Crisp Elwynn Apple
(@Applebough,   1,          13810), -- Eversong Sunfruit
(@Applebough,   1,          11950), -- Tirisfal Grapes
(@Applebough,   1,          4538),  -- Hillsbrad Watermelon
(@Applebough,   1,          4537);  -- Kezan Banana

-- Sweets Vendor
ELETE FROM npc_vendor WHERE Entry=@CakeVendor; INSERT INTO npc_vendor 
-- -----------------------------------------------------------------------
(Entry,         Slot,       Item) VALUES
-- -----------------------------------------------------------------------
(@CakeVendor,   1,          42430), -- Sprinkled Doughnut
(@CakeVendor,   1,          22895), -- Cinnamon Roll
(@CakeVendor,   1,          42428), -- Vanilla Cupcake
(@CakeVendor,   1,          42431), -- Dalaran Brownie
(@CakeVendor,   1,          42433); -- Chocolate Cake
