...
REPLACE INTO `creature_template_addon` (`entry`, `path_id`, `mount`, `bytes1`, `bytes2`, `emote`, `visibilityDistanceType`, `auras`) VALUES (42001, 0, 0, 1, 0, 0, 0, '73220');
...
INSERT INTO `creature` (`id1`, `id2`, `id3`, `map`, `zoneId`, `areaId`, `spawnMask`, `phaseMask`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `wander_distance`, `currentwaypoint`, `curhealth`, `curmana`, `MovementType`, `npcflag`, `unit_flags`, `dynamicflags`, `ScriptName`, `VerifiedBuild`) VALUES (@Lichking, 0, 0, 571, 0, 0, 1, 1, 0, 8516.24, 867.364, 583.709, 4.70001, 300, 0, 0, 17431250, 0, 0, 0, 0, 0, '', NULL);
-- Sit aura
...
DELETE FROM `creature` WHERE `guid` IN (@HonorVend,@ArenaVend);
...
(@HonorVend, 0, 0, 571, 0, 0, 1, 1, 1, 8520.04, 820.728, 562.89, 4.57566, 300, 0, 0, 12600, 0, 0, 0, 0, 0, '', NULL),
(@ArenaVend, 0, 0, 571, 0, 0, 1, 1, 1, 8510.16, 820.545, 562.89, 4.75237, 300, 0, 0, 12600, 0, 0, 0, 0, 0, '', NULL);
...
DELETE FROM `creature` WHERE `guid` IN (@ArenaQue1,@ArenaTeam1,@ArenaQue2,@ArenaTeam2,@OneVsOne1,@OneVsOne2);
INSERT INTO `creature` (`id1`, `id2`, `id3`, `map`, `zoneId`, `areaId`, `spawnMask`, `phaseMask`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `wander_distance`, `currentwaypoint`, `curhealth`, `curmana`, `MovementType`, `npcflag`, `unit_flags`, `dynamicflags`, `ScriptName`, `VerifiedBuild`) VALUES
(@ArenaQue1,  0, 0, 571, 0, 0, 1, 1, 0, 8480.12, 792.419, 559.69, 6.28238,  300, 0, 0, 10635, 0, 0, 0, 0, 0, '', NULL),
(@ArenaTeam1, 0, 0, 571, 0, 0, 1, 1, 0, 8482.91, 787.78,  559.69, 0.285871, 300, 0, 0, 10635, 0, 0, 0, 0, 0, '', NULL),
(@ArenaQue2,  0, 0, 571, 0, 0, 1, 1, 0, 8550.52, 792.058, 559.69, 3.14473,  300, 0, 0, 10635, 0, 0, 0, 0, 0, '', NULL),
(@ArenaTeam2, 0, 0, 571, 0, 0, 1, 1, 0, 8547.77, 796.83,  559.69, 3.33321,  300, 0, 0, 10635, 0, 0, 0, 0, 0, '', NULL),
(@OneVsOne1,  0, 0, 571, 0, 0, 1, 1, 0, 8482.95, 797.116, 559.69, 5.95251,  300, 0, 0, 12600, 0, 0, 0, 0, 0, '', NULL),
(@OneVsOne2,  0, 0, 571, 0, 0, 1, 1, 0, 8547.29, 787.237, 559.69, 2.79522,  300, 0, 0,  8982, 0, 0, 0, 0, 0, '', NULL);

-- Training Dummies
DELETE FROM `creature` WHERE `guid` IN (@Dummy1,@Dummy2);
...
DELETE FROM `creature` WHERE `guid` IN (@HonorVend,@ArenaVend);
INSERT INTO `creature` (`id1`, `id2`, `id3`, `map`, `zoneId`, `areaId`, `spawnMask`, `phaseMask`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `wander_distance`, `currentwaypoint`, `curhealth`, `curmana`, `MovementType`, `npcflag`, `unit_flags`, `dynamicflags`, `ScriptName`, `VerifiedBuild`) VALUES
(@Spectator1, 0, 0, 571, 0, 0, 1, 1, 0, 8555.83, 781.607, 574.617, 2.88161, 300, 0, 0, 5052, 0, 0, 0, 0, 0, '', NULL),
(@Spectator2, 0, 0, 571, 0, 0, 1, 1, 0, 8474.87, 803.813, 574.622, 6.05461, 300, 0, 0, 5052, 0, 0, 0, 0, 0, '', NULL),
(@Spectator3, 0, 0, 571, 0, 0, 1, 1, 0, 8489.74, 759.134, 574.635, 0.953464, 300, 0, 0, 4652, 0, 0, 0, 0, 0, '', NULL),
(@Spectator4, 0, 0, 571, 0, 0, 1, 1, 0, 8552.98, 802.159, 573.656, 3.34501, 300, 0, 0, 5052, 0, 0, 0, 0, 0, '', NULL),
(@Spectator5, 0, 0, 571, 0, 0, 1, 1, 0, 8556.08, 783.996, 574.62, 2.93267, 300, 0, 0, 8982, 0, 0, 0, 0, 0, '', NULL),
(@Spectator6, 0, 0, 571, 0, 0, 1, 1, 0, 8553.33, 800.124, 573.656, 3.31752, 300, 0, 0, 5052, 0, 0, 0, 0, 0, '', NULL),
(@Spectator7, 0, 0, 571, 0, 0, 1, 1, 0, 8474.22, 801.163, 574.615, 6.03498, 300, 0, 0, 4916, 0, 0, 0, 0, 0, '', NULL);
...
-- -----------------------------------
-- Arthas Throne
DELETE FROM `gameobject` WHERE `guid` IN (4200050);
INSERT INTO `gameobject` (`guid`, `id`, `map`, `zoneId`, `areaId`, `spawnMask`, `phaseMask`, `position_x`, `position_y`, `position_z`, `orientation`, `rotation0`, `rotation1`, `rotation2`, `rotation3`, `spawntimesecs`, `animprogress`, `state`, `ScriptName`, `VerifiedBuild`) VALUES 
(4200050, 202161, 571, 0, 0, 1, 1, 8515.25, 792.298, 555.44, 1.57079, -0, -0, -0.707105, -0.707109, 300, 255, 1, '', 0);
...
(4200051, 195318, 571, 0, 0, 1, 1, 8515.33, 792.087, 559.69, 0.778307, -0, -0, -0.379405, -0.925231, 300, 0, 1, '', 0);
