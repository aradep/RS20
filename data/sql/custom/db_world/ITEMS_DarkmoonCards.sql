...
-- Decks
UPDATE item_template SET `bonding` = 0, `maxcount` = 1, `buyprice` = 0, `sellprice` = 1000000,  `ItemLevel` = 35, `requiredlevel` = 20 WHERE `entry` IN (44326,44259,31890,31914,19228,19267,19277,31891,19257,44294,31907);
-- Cards
