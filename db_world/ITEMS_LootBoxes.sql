...
@Name           = 'Spoils of War',
@Description    = 'Contains random items.';
UPDATE `item_template` SET `name`=@Name,`description`=@Description, `quality`=@Quality, `minmoneyloot`=@Money, `maxmoneyloot`=@Money, `sellprice`=0, `lockid`=0 where `entry`=@Entry;
